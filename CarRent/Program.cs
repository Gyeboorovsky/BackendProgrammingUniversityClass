...
builder.Services.AddIdentity<User, IdentityRole>() // se this options if you want to implement email confirmation: (options => options.SignIn.RequireConfirmedAccount = true)
